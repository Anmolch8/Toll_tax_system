...
class main:
        ...
        def __init__(self):
                ...
                img=ImageTk.PhotoImage(Image.open("Resources/login.jpg"))
                ...
                img1=ImageTk.PhotoImage(Image.open("Resources/workers.jpg"))
...
def log_true():
                        ...
                        bg=ImageTk.PhotoImage(Image.open("Resources/toll1.jpg"))
                        master.iconbitmap("icons/tollplaza1.ico")
                        img=ImageTk.PhotoImage(Image.open("Resources/NH.png"))

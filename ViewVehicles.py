...
class Vehicle_main:
    ...
    def search(self):
        ...
        for row in res:
            if self.cb.get() == "Vehicle category":
                ...
                messagebox.showerror("","No Option Selected",parent=self.regis)
    ...
    def __init__(self):
        ...
        img=ImageTk.PhotoImage(Image.open("Resources/search1.png"))
        ...
        refresh_img=ImageTk.PhotoImage(Image.open("Resources/refresh1.png"))
        ...
        back_img=ImageTk.PhotoImage(Image.open("Resources/icon1.png"))
